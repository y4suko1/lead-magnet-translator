...
3. **For every claim that characterises what a quote shows** (the comparison "worked," the room "reacted well," someone "agreed"), **re-read the quote and the lines around it and ask: does the transcript actually show this, or only imply it, or show the opposite?** A quote can be real and exact and still be used to claim something the surrounding conversation doesn't support.
4. **Fix anything this finds before showing the reader anything.** A miscount, a misattribution, or an oversold characterisation gets corrected in both the menu and the sources file, not flagged and left as-is.
